...
def make_public_book(book):
    ...
    new_book['uri'] = url_for('get_book', bookid=book['identifier']['ISBN-10'], _external=True)
    return new_book
...
def update_book(bookid):
    ...
    book[0]['identifier']['ISBN-10'] = request.json['identifier']['ISBN-10']
...
@app.route('/echoxml', methods=['POST'])
def echo():
